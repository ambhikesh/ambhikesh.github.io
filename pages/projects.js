          ...
          {repositories.map((repo) => (
            <div key={repo.id} className='m-5 rounded-xl hover:shadow-2xl hover:scale-105 transition p-2'>
              <a href={"https://github.com/True-Fox/" + repo.name}>
                <li>
                  <div className='ml-2 mb-1 text-2xl  no-underline  font-mono'>{repo.name}</div>
                  <div className="ml-2   text-xl  text-slate-700 font-mono">{repo.description}</div>
                </li>
              </a>
            </div>
          ))}
...
//       </Head>
//       <div className='m-5'>
//         <span className='text-3xl text-black'>Projects</span>
//         <ul>
...
//                 <li>
//                   <div className='ml-2 text-lg no-underline text-black'>File-Search-and-Execution-Tool</div>
...
//                 <li>
//                   <div className='ml-2 text-lg no-underline text-black'>Book-sharing-system </div>
...
//                 <li>
//                   <div className='ml-2 text-lg no-underline text-black'>WikiPy-Search </div>
...
//                 <li>
//                   <div className='ml-2 text-lg no-underline text-black'>Spotify-to-Mp3</div>
...
//                 <li>
//                   <div className='ml-2 text-lg no-underline text-black'>JustEvs </div>
...
//                 <li>
//                   <div className='ml-2 text-lg no-underline text-black'>Virtual-Casino</div>
